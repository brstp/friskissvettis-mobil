            ...
            if (FriskisService.IsLoggedIn)
            {
                switch (bookType)
                {
                    case BookType.Bookable:
                        ...
                        return @"<a class=""no-decoration"" href=""/loggedin/ConfirmBooking.aspx?id=" + item.Id + @"&date=" + item.From.ToShortDateString() + @""">
                    ...
                    case BookType.Standby:
                        ...
                        return @"<a class=""no-decoration"" href=""/loggedin/ConfirmBooking.aspx?m=standby&id=" + item.Id + @""">
                            <div class=""button button-red button-small "">
                                " + Resources.LocalizedText.BookStandby + /* @"
                                <img alt=""icon"" src=""/images/button/button-red-arrow.png"" />" */
                            "</div>" + 
                        "</a>";
