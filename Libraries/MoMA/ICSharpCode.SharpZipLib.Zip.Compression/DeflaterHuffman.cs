			...
			public void CalcBLFreq(DeflaterHuffman.Tree blTree)
			{
				...
				while (i < this.numCodes)
				{
					...
					else
					{
						...
						if (num != num3)
						{
							short[] expr_42_cp_0 = blTree.freqs;
							int expr_42_cp_1 = num3;
							expr_42_cp_0[expr_42_cp_1] += 1;
							num2 = 0;
						}
					}
					num = num3;
					...
					if (num2 < num5)
					{
						short[] expr_90_cp_0 = blTree.freqs;
						int expr_90_cp_1 = num;
						expr_90_cp_0[expr_90_cp_1] += (short)num2;
					}
					else
					{
						if (num != 0)
						{
							short[] expr_AF_cp_0 = blTree.freqs;
							int expr_AF_cp_1 = 16;
							expr_AF_cp_0[expr_AF_cp_1] += 1;
						}
						else
						{
							if (num2 <= 10)
							{
								short[] expr_CF_cp_0 = blTree.freqs;
								int expr_CF_cp_1 = 17;
								expr_CF_cp_0[expr_CF_cp_1] += 1;
							}
							else
							{
								short[] expr_E7_cp_0 = blTree.freqs;
								int expr_E7_cp_1 = 18;
