	...
	public class BZip2OutputStream : Stream
	{
		...
		private void SendMTFValues()
		{
				...
				for (m = 0; m < this.nMTF; m = num7 + 1)
				{
					...
					else
					{
						for (int num23 = m; num23 <= num7; num23++)
						{
							...
							{
								short[] expr_394_cp_0 = array4;
								int expr_394_cp_1 = num25;
								expr_394_cp_0[expr_394_cp_1] += (short)array[num25][(int)num24];
							}
						}
					}
					int num26 = 999999999;
					...
					num13 += num26;
					array3[num27]++;
					this.selector[num] = (char)num27;
					num++;
					for (int num29 = m; num29 <= num7; num29++)
					{
						array2[num27][(int)this.szptr[num29]]++;
					}
				}
				for (int num30 = 0; num30 < num3; num30++)
				{
					BZip2OutputStream.HbMakeCodeLengths(array[num30], array2[num30], num2, 20);
				}
			}
			if (num3 >= 8)
			{
			...
			for (int num32 = 0; num32 < num; num32++)
			{
				...
				array5[0] = c2;
				this.selectorMtf[num32] = (char)num33;
			}
			...
			for (int num35 = 0; num35 < num3; num35++)
			{
				...
				BZip2OutputStream.HbAssignCodes(array6[num35], array[num35], num36, num37, num2);
			}
			...
			{
				for (int num45 = 0; num45 < (int)this.selectorMtf[num44]; num45++)
				{
					this.BsW(1, 1);
				}
				this.BsW(1, 0);
			...
			while (m < this.nMTF)
			{
				...
				{
					this.BsW((int)array[(int)this.selector[num49]][(int)this.szptr[num50]], array6[(int)this.selector[num49]][(int)this.szptr[num50]]);
				}
				m = num7 + 1;
				num49++;
			}
		...
		private void RandomiseBlock()
		{
			...
			for (int i = 0; i <= this.last; i++)
			{
				...
				num--;
				byte[] expr_58_cp_0 = this.block;
				int expr_58_cp_1 = i + 1;
				expr_58_cp_0[expr_58_cp_1] ^= ((num == 1) ? 1 : 0);
				byte[] expr_7A_cp_0 = this.block;
				int expr_7A_cp_1 = i + 1;
				expr_7A_cp_0[expr_7A_cp_1] &= 255;
