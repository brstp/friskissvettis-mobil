...
namespace HtmlAgilityPack
{
	public class HtmlNodeNavigator : XPathNavigator
	{
		...
		internal void InternalTrace(object traceValue)
		{
			...
			string arg_1F_0 = stackFrame.GetMethod().Name;
			if (this._currentnode != null)
			{
				string arg_36_0 = this._currentnode.Name;
			}
			if (this._currentnode == null)
			{
				return;
			...
			case HtmlNodeType.Comment:
			{
				string arg_7A_0 = ((HtmlCommentNode)this._currentnode).Comment;
				return;
			}
			case HtmlNodeType.Text:
			{
				string arg_8C_0 = ((HtmlTextNode)this._currentnode).Text;
				return;
			}
			}
			string arg_9F_0 = this._currentnode.CloneNode(false).OuterHtml;
		}
		private void Reset()
		{
			this._currentnode = this._doc.DocumentNode;
