	...
	public class HtmlNode : IXPathNavigable
	{
		...
		public string Name
		{
			get
			{
				if (this._name == null)
				{
					this.Name = this._ownerdocument._text.Substring(this._namestartindex, this._namelength);
				}
				if (this._name == null)
				{
					return string.Empty;
		...
		static HtmlNode()
		{
			...
			HtmlNode.ElementsFlags = new Hashtable();
		...
		public static bool CanOverlapElement(string name)
		{
			...
			object obj = HtmlNode.ElementsFlags[name.ToLower()];
			return obj != null && ((HtmlElementFlag)obj & HtmlElementFlag.CanOverlap) != (HtmlElementFlag)0;
		}
		...
		public static bool IsCDataElement(string name)
		{
			...
			object obj = HtmlNode.ElementsFlags[name.ToLower()];
			return obj != null && ((HtmlElementFlag)obj & HtmlElementFlag.CData) != (HtmlElementFlag)0;
		}
		public static bool IsClosedElement(string name)
		{
			...
			object obj = HtmlNode.ElementsFlags[name.ToLower()];
			return obj != null && ((HtmlElementFlag)obj & HtmlElementFlag.Closed) != (HtmlElementFlag)0;
		}
		public static bool IsEmptyElement(string name)
		{
			...
			object obj = HtmlNode.ElementsFlags[name.ToLower()];
			return obj != null && ((HtmlElementFlag)obj & HtmlElementFlag.Empty) != (HtmlElementFlag)0;
		}
		...
		{
			foreach (HtmlNode current in this.DescendantNodes())
			{
				yield return current;
			}
			yield break;
		...
		public HtmlNodeCollection SelectNodes(string xpath)
		{
			...
			HtmlNodeNavigator htmlNodeNavigator = new HtmlNodeNavigator(this._ownerdocument, this);
		...
		public void WriteTo(TextWriter outText)
		{
			...
			case HtmlNodeType.Text:
			{
				...
				if (this._ownerdocument.OptionOutputAsXml)
				{
					outText.Write(HtmlDocument.HtmlEncode(text2));
					return;
				}
				outText.Write(text2);
				return;
		...
		internal void CloseNode(HtmlNode endnode)
		{
			...
			if (!this.Closed)
			{
				...
				HtmlNode htmlNode2 = this._ownerdocument._lastnodes[this.Name] as HtmlNode;
				if (htmlNode2 == this)
				{
		...
		internal void SetId(string id)
		{
			...
			if (htmlAttribute == null)
			{
				htmlAttribute = this._ownerdocument.CreateAttribute("id");
			}
