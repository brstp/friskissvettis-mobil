            ...
            <ItemTemplate>
                ...
                <div class="container-schedule container-workout-schedule">
                    <table style="width: 100%">
                        <tr>
                            <td valign="middle"><img class="difficulty" src="/images/workout/dot-<%# DataBinder.Eval(Container.DataItem, "Level") %>.png" /></td>
                            <td valign="middle"><h1><%# DataBinder.Eval(Container.DataItem, "Name") %></h1></td>
                            <td valign="middle"></td>
                        </tr>
                        <tr>
                            <td></td>
